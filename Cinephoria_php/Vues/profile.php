            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="changer_mot_de_passe.php">Changer le mot de passe</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Mes</i>Reservations</h6>
                      <?php 
                        foreach ($reservation_donnees as $ligne) {
                            $mon_film = $film->getFilmById($pdo, $ligne["film_id"]);
                            $ma_seance = $seance->getById($ligne["seance_id"]);
                            print('
                                <h6>'.$mon_film["titre"].'</h6>
                                <small> Date : '.$ligne["date_reservation"].' -- Qualite : '.$ma_seance["qualité"].' </small>
